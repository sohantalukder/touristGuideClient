...
import Background from '../../image/feedback/main2.svg';
...
const ShareExperience = () => {
	...
	return (
		<div>
			<div className="container mx-auto max-w-[1180px] !px-6 lg:px-0 py-16 mt-16">
				<h1 className="text-2xl md:text-3xl relative font-semibold pb-6 header">
					Feel free to drop your journey experiance and your journey picture.
				</h1>
				<p className="mb-12">
							...
							<ul className="w-full lg:w-[473px] space-y-5 mx-auto">
								...
								<li className="flex flex-col items-start relative">
									...
									<textarea
										...
										className="py-3 !px-4  w-full lg:w-[473px] lg:px-0 border border-mediumGray  outline-none focus:outline-none focus:border-green text-black transition-all"></textarea>
								</li>
							</ul>
							{/* Button */}
